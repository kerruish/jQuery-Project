$(document).ready(function() {
	...
	$.getJSON("http://localhost:14579/api/births", function (data)  {
                 ...
                 var tbl = "<div id='col3' class='col-xs-12'><table style='display:none' class='highchart' data-graph-type='line' data-graph-legend-disabled='1' data-graph-container-before='1' data-graph-height='400' data-graph-width='400' >";
