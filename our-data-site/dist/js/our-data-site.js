...
;$(document).ready(function () {
        ...
        contextICA27.householdsWithComputerPercentage = [];
        contextICA27.householdsWithComputerPercentageYear = [];
        ...
        $.ajax({
            ...
            success: function(data) {
                for (var i = 0; i < data.length; i++) {
                    ...
                    {
                        contextICA27.householdsWithComputerPercentage.push(data[i].value);
                        contextICA27.householdsWithComputerPercentageYear.push(data[i]["Year"]);
                    }
                }
                ...
                var options = {
                    ...
                    xAxis: {
                        categories: contextICA27.householdsWithComputerPercentageYear
                    },
                    series: [{
                        name: 'Households with a computer',
                        data: contextICA27.householdsWithComputerPercentage,
                        pointWidth: 10
                    }]
                };
                var chart = new Highcharts.Chart(options);
